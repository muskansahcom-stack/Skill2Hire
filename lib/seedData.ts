...
export function generateInitialDatabase(): DatabaseSchema {
  const users: User[] = [
    ...
    // Admin
    { id: 'u_admin', email: 'admin@skill2hire.com', phone: '+91 98765 43213', passwordHash: 'b19b5d4cd462d2dc0bb89ce5ff0e6ca96a32fdf97c30f5e97de7f0e611bba16a', role: 'owner_admin', isOwner: true, name: 'Skill2Hire SuperAdmin (Platform Owner)', avatar: 'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?w=150&auto=format&fit=crop&q=80', createdAt: '2025-01-01T00:00:00Z' }
  ];
